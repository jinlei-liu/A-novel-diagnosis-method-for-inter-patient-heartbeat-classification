...
######################################################################################
data_f_ds2=np.load('/home/lingang/liujinlei/mit_classify/SVDB/data2/x2_test.npy')
data_f_ds2=data_f_ds2.astype(np.float64)
data_f_ds1=np.load('/home/lingang/liujinlei/mit_classify/SVDB/data2/x2_train.npy')
data_f_ds1=data_f_ds1.astype(np.float64)

data_ds1=np.load('/home/lingang/liujinlei/mit_classify/SVDB/data2/x1_train.npy')
data_ds1=np.squeeze(data_ds1, axis=1).astype(np.float64)
label_ds1=np.load('/home/lingang/liujinlei/mit_classify/SVDB/data2/y_train.npy')
label_ds1=label_ds1.astype(np.float64)
print(Counter(label_ds1.reshape(-1)))

data_ds2=np.load('/home/lingang/liujinlei/mit_classify/SVDB/data2/x1_test.npy')
data_ds2=np.squeeze(data_ds2, axis=1).astype(np.float64)
label_ds2=np.load('/home/lingang/liujinlei/mit_classify/SVDB/data2/y_test.npy')
label_ds2=label_ds2.astype(np.float64)
print(Counter(label_ds2.reshape(-1)))

data1_ds1=np.load('/home/lingang/liujinlei/mit_classify/SVDB/data2/x0_train.npy')
data1_ds1=np.squeeze(data1_ds1, axis=1).astype(np.float64)
data1_ds2=np.load('/home/lingang/liujinlei/mit_classify/SVDB/data2/x0_test.npy')
...
#    filepath="/home/lingang/liujinlei/mit_classify/modelfiles/classification_20211111_512batch.hdf5"#保存模型的路径
    filepath="/home/lingang/liujinlei/mit_classify/SVDB/model20230206/model_{epoch:02d}-{val_categorical_accuracy:.2f}.h5"
...
#                    callbacks=callback_lists,epochs=200,batch_size=1024)
    history = model.fit([X_train,X_250train,X_train_f],y_train,validation_data=([Data_DS2,Data_250DS2,Data_f_DS2],Label_DS2),class_weight =classweight,
                    callbacks=callback_lists,epochs=50,batch_size=1024) 
